                ...
                <div class="space-y-12">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="mt-2">
                                <input type="text" name="make" id="make"  value="<?= $note['make'] ?? ''?>" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="mt-2">
                                <input type="text" name="model" id="model"  value="<?= $car['model'] ?? '' ?>" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="mt-2">
                                <input type="text" name="year" id="year"  value="<?= $car['year'] ?? '' ?>" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="mt-2">
                                <input type="text" name="color" id="color"  value="<?= $car['color'] ?? '' ?>" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
