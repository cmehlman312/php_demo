                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="<?= $constants['form']['div'] ?>">
                                <input type="text" name="make" id="make"  value="<?= $_POST['make'] ?? ''?>" required class="<?= $constants['form']['input'] ?>">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="<?= $constants['form']['div'] ?>">
                                <input type="text" name="model" id="model"  value="<?= $_POST['model'] ?? '' ?>" required class="<?= $constants['form']['input'] ?>">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="<?= $constants['form']['div'] ?>">
                                <input type="text" name="year" id="year"  value="<?= $_POST['year'] ?? '' ?>" required class="<?= $constants['form']['input'] ?>">
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="<?= $constants['form']['div'] ?>">
                                <input type="text" name="color" id="color"  value="<?= $_POST['color'] ?? '' ?>" required class="<?= $constants['form']['input'] ?>">
